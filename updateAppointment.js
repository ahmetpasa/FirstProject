...
export default function updateAppointment({ route, navigation }) {
    const[date, setDate] = useState(route.params.updateData.dateof_app);
    ...
    return(
        <View style={globalStyles.formContainer}>
            ...
            enableReinitialize
            initialValues={{
                dateof_app: route.params.updateData.dateof_app,
                time: route.params.updateData.time,
                description_app: route.params.updateData.description_app,
                isFamily: false,
            }}
            onSubmit={(values) => {
            ...
            console.log(values);
                axios(
                    {
                      method: 'put',
                      url: 'http://192.168.1.4:8083/api/updateapp/'+ route.params.updateData.appointmentID,
                      data: form, 
            ...
            <CardView style={globalStyles.formCard} cardElevation={5}
                  ...
                  cornerRadius={5}
                  cornerOverlap={false}>
            <Text style={globalStyles.formTitle}>Update Appointment</Text>
        ...
        <TextInput
            style={globalStyles.textInputStyle}
            value={formikProps.values.description_app}
